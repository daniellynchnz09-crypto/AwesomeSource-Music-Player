 ...
 * limit via a small mutex-guarded delay around every call (so bulk scans - however
 * many coroutines kick off queries - still only ever hit MusicBrainz serially),
 * retries on failure with backoff, and maps raw responses into [MbCandidate].
 *
