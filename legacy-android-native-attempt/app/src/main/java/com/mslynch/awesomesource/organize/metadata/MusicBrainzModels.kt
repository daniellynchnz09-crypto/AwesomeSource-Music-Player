...
/**
 * DTOs for MusicBrainz's JSON web service (`ws/2/*?fmt=json`). The legacy desktop
 ...
 * blank field, not a crash" rule. **Not yet verified against a live response** -
 * there's no network/JDK toolchain in this dev environment yet (see Claude/To Do
 * list.md) - treat field names as best-effort from MusicBrainz's public docs until
 * a real round trip confirms them.
 */
